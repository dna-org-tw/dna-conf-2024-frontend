...
export default async function Home({
	...
	return (
		<main className="flex min-h-screen flex-col items-center justify-between gap-y-20">
			...
			<section id="speaker" className="w-full px-24">
				<HeaderTitleWithLine
			...
			<section id="ticket" className="w-full px-24">
			...
			<section id="transportation" className="w-full py-20 px-8 sm:px-24">
				<HeaderTitleWithLine
			...
			<section id="call-for-sponsor" className="w-full px-24">
